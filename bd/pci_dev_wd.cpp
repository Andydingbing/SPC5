...
wd_pci_dev::wd_pci_dev(const string &descriptor)
{
...
int32_t wd_pci_dev::init(const string &dev)
{
    ignore_unused(dev);
    return 0;
}

int32_t wd_pci_dev::init(const string &dev,uint32_t vid,uint32_t did)
{
