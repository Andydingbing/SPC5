...
//freq string to exact number
//e.g. "50M"--->50000000	"1G"--->1000000000
int32_t RD_API str2freq(const char *str,double &freq);
int32_t RD_API str2freq(const char *str,float &freq);
int32_t RD_API str2freq(const char *str,uint64_t &freq);
int32_t RD_API str2freq(const char *str,int64_t &freq);
...
int32_t RD_API freq2array(const char *in1,const char *in2,int64_t step,int64_t *out = NULL,int64_t *freq_star = NULL,int64_t *freq_stop = NULL,int64_t *max = NULL,int64_t *min = NULL);

//separate freq string to freq array
int32_t RD_API freq2array(char *pin,int64_t *pout);

//get which section does the "freq" in
int32_t RD_API freq_section(char *pin1,char *pin2,int64_t freq);
...
double RD_API round(double x,int32_t digit);
...
int16_t RD_API x9119vol2val(double vol);
double  RD_API x9119val2vol(int16_t val);

double RD_API mcp3208ad2vol(uint32_t ad);
double RD_API tc1407vol2temp(double vol_mv);
