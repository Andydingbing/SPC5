...
{
	// Log->trace(_T("in CXGroupBox::CXGroupBox\n"));
}
...
//=============================================================================
{
	// Log->trace(_T("in CXGroupBox::PreSubclassWindow\n"));
	...
	if (m_bThemed)
	{
		...
		{
			// Log->trace(_T("WARNING - GetThemeColor failed\n"));
			m_crText = GetSysColor(COLOR_HIGHLIGHT);
		}
	}
	else
	{
		// Log->trace(_T("not themed\n"));
		m_crText = GetSysColor(COLOR_BTNTEXT);
	}
...
//=============================================================================
{
	// Log->trace(_T("in CXGroupBox::DrawItem\n"));
	...
	// Log->trace(_T("..... m_nYOffset=%d  m_sizeText.cy=%d  m_nIconSize=%d\n"), m_nYOffset, m_sizeText.cy, m_nIconSize);
...
//=============================================================================
{
	// Log->trace(_T("in CXGroupBox::DrawEtchedRectangle\n"));
...
//=============================================================================
{
	if (m_eStyle == groupbox)
	{
		// Log->trace(_T("DrawBorder: groupbox\n"));
		...
		{
			// Log->trace(_T("drawing with theme\n"));
	...
	else
	{
		...
		// Log->trace(_T("DrawBorder: header\n"));
...
//=============================================================================
{
	// Log->trace(_T("in CXGroupBox::SetFont =================\n"));
	ASSERT(pLogFont);
...
//=============================================================================
{
	// Log->trace(_T("in CXGroupBox::SetIcon 1\n"));
...
//=============================================================================
{
	// Log->trace(_T("in CXGroupBox::SetIcon 2\n"));
...
//=============================================================================
{
	// Log->trace(_T("in CXGroupBox::SetBorderStyle: %d\n"), eStyle);
