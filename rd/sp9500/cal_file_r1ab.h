...
class RD_API cal_file_r1ab : public rd::cal_file
{
    DECLARE_CAL_FILE()
...
public:
    void get_tx_att(uint64_t freq,rd::io_mode_t mode,float *att);
    void get_tx_att(uint64_t freq,rd::io_mode_t mode,int32_t att,double &offset);
    void get_tx_pwr(uint64_t freq,double pwr,rd::io_mode_t mode,
