...
class RD_API sp1401 : boost::noncopyable
{
public:
...
public: \
    ...
    virtual int32_t set_io_mode(rd::io_mode_t mode); \
    virtual int32_t get_io_mode(rd::io_mode_t &mode); \
...
public:
    ...
    virtual int32_t set_io_mode(rd::io_mode_t mode) = 0;
    virtual int32_t get_io_mode(rd::io_mode_t &mode) = 0;
