...
public:
    ...
    virtual int32_t set_tx_freq(const uint64_t) { return 0; }
    ...
    virtual int32_t set_tx_att(const double) { return 0; }
    virtual int32_t set_tx_mod_en(bool) { return 0; }
    virtual int32_t set_pwr_en(const bool) { return 0; }

    virtual int32_t set_rx_freq(const uint64_t) { return 0; }
