...
public:
    ...
    int32_t open()
    {
        ...
        make_sure_has(cal_table_t::TX_IF_FR_0000_7500,&_tx_if_fr_0000_7500);
    ...
    tx_if_fr_3000_7500_table_t *tx_if_fr_3000_7500() { return &_tx_if_fr_0000_7500; }
...
private:
    ...
    tx_if_fr_3000_7500_table_t _tx_if_fr_0000_7500;
