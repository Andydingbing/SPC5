...
int32_t ns_sp9500x::dma_mgr::init(const uint32_t dl_samples,const uint32_t ul_samples)
{
    ...
    RFU_V9_REG_DECL_2(0x0180,0x01a0);
    RFU_V9_REG_DECL_2(0x0181,0x01a1);
    RFU_V9_REG_DECL_2(0x0182,0x01a2);
    RFU_V9_REG_DECL_2(0x0183,0x01a3);
    RFU_V9_REG_DECL_2(0x0184,0x01a5);
    RFU_V9_REG_DECL_2(0x0185,0x01a6);
    RFU_V9_REG_DECL(0x0186);
    RFU_V9_REG_DECL(0x0187);
    RFU_V9_REG_DECL(0x0188);

    // DL / FPGA Read
    RFU_V9_REG(0x0186).addr_low  = _memory_dl.phy_addr(0) & 0x00000000ffffffff;
    RFU_V9_REG(0x0187).addr_high = _memory_dl.phy_addr(0) >> 32;
    RFU_V9_REG(0x0188).length    = _memory_dl.block_size(0);
    RFU_V9_W(0x0186);
    RFU_V9_W(0x0187);
    RFU_V9_W(0x0188);

    // UL / FPGA Write
    RFU_V9_REG_2(0x0181,0x01a1).cnt = _memory_ul.total_block();
    RFU_V9_W_2(0x0181,0x01a1);

    for (uint32_t i = 0;i < _memory_ul.total_block();++i) {
        RFU_V9_REG_2(0x0182,0x01a2).n = i;
        RFU_V9_REG_2(0x0183,0x01a3).addr_low  = _memory_ul.phy_addr(i) & 0x00000000ffffffff;
        RFU_V9_REG_2(0x0184,0x01a5).addr_high = _memory_ul.phy_addr(i) >> 32;
        RFU_V9_REG_2(0x0185,0x01a6).length    = _memory_ul.block_size(i);
        RFU_V9_W_2(0x0182,0x01a2);
        RFU_V9_W_2(0x0183,0x01a3);
        RFU_V9_W_2(0x0184,0x01a5);
        RFU_V9_W_2(0x0185,0x01a6);
        RFU_V9_OP_2(0x0180,0x01a0);
    }
...
{
    RFU_V9_REG_DECL(0x018e);
    RFU_V9_REG_DECL(0x018f);
    RFU_V9_REG_DECL(0x0192);
    ...
    RFU_V9_REG(0x018f).length = byte_target;
    RFU_V9_W(0x018f);
    RFU_V9_OP(0x018e);
    ...
    RFU_V9_R(0x0192);
    while (RFU_V9_REG(0x0192).byte == 0) {
        RFU_V9_R(0x0192);
    ...
    while(1) {
        for (int32_t i = 0;i < 5;++i) {
            RFU_V9_R(0x0192);
            byte_cur[i] = RFU_V9_REG(0x0192).byte;
...
{
    RFU_V9_REG_DECL_2(0x0189,0x01a7);

    RFU_V9_OP_2(0x0189,0x01a7);
    return 0;
}

int32_t ns_sp9500x::dma_mgr::fpga_w_trans() const
{
    RFU_V9_REG_DECL_2(0x018d,0x01ab);
    ...
    RFU_V9_R_2(0x018d,0x01ab);
    while (RFU_V9_REG_2(0x018d,0x01ab).byte == 0) {
        RFU_V9_R_2(0x018d,0x01ab);
...
//        }
    ...
    while(1) {
        for (int32_t i = 0;i < 5;++i) {
            RFU_V9_R_2(0x018d,0x01ab);
            byte_cur[i] = RFU_V9_REG_2(0x018d,0x01ab).byte;
...
int32_t ns_sp9500x::dma_mgr::set_fpga_ddr_addr_r(const uint64_t addr)
{
    ...
    RFU_V9_REG(0x0190).addr_low  = addr & 0x00000000ffffffff;
    RFU_V9_REG(0x0191).addr_high = addr >> 32;
    RFU_V9_W(0x0190);
    RFU_V9_W(0x0191);
    return 0;
}
...
int32_t ns_sp9500x::dma_mgr::get_fpga_ddr_addr_r(uint64_t &addr)
{
    ...
    RFU_V9_R(0x0190);
    RFU_V9_R(0x0191);
    addr = (RFU_V9_REG(0x0190).addr_low);
    addr |= uint64_t(RFU_V9_REG(0x0191).addr_high) << 32;
    return 0;
}

int32_t ns_sp9500x::dma_mgr::set_fpga_ddr_addr_w(const uint64_t addr)
{
    RFU_V9_REG_DECL_2(0x018b,0x01a9);
    RFU_V9_REG_DECL_2(0x018c,0x01aa);
    RFU_V9_REG_DECL_2(0x024d,0x026d);
    RFU_V9_REG_DECL_2(0x024e,0x026e);

    RFU_V9_REG_2(0x018b,0x01a9).addr_low  = addr & 0x00000000ffffffff;
    RFU_V9_REG_2(0x018c,0x01aa).addr_high = addr >> 32;
    RFU_V9_REG_2(0x024d,0x026d).addr_low  = RFU_V9_REG_2(0x018b,0x01a9).addr_low;
    RFU_V9_REG_2(0x024e,0x026e).addr_high = RFU_V9_REG_2(0x018c,0x01aa).addr_high;
    RFU_V9_W_2(0x018b,0x01a9);
    RFU_V9_W_2(0x018c,0x01aa);
    RFU_V9_W_2(0x024d,0x026d);
    RFU_V9_W_2(0x024e,0x026e);
    return 0;
}
...
int32_t ns_sp9500x::dma_mgr::get_fpga_ddr_addr_w(uint64_t &addr)
{
    ...
    RFU_V9_R_2(0x018b,0x01a9);
    RFU_V9_R_2(0x018c,0x01aa);
    addr = (RFU_V9_REG_2(0x018b,0x01a9).addr_low);
    addr |= uint64_t(RFU_V9_REG_2(0x018c,0x01aa).addr_high) << 32;
    return 0;
}

int32_t ns_sp9500x::dma_mgr::set_fpga_w_samples(const uint32_t samples) const
{
    RFU_V9_REG_DECL_2(0x018a,0x01a8);

    RFU_V9_REG_2(0x018a,0x01a8).length = samples << 2;
    RFU_V9_W_2(0x018a,0x01a8);
    return 0;
}
...
int32_t ns_sp9500x::dma_mgr::get_fpga_w_samples(uint32_t &samples) const
{
    ...
    RFU_V9_R_2(0x018a,0x01a8);
    samples = RFU_V9_REG_2(0x018a,0x01a8).length >> 2;
    return 0;
}

int32_t ns_sp9500x::dma_mgr::set_fpga_w_timeout_time(const uint32_t us) const
{
    RFU_V9_REG_DECL_2(0x0247,0x0267);

    RFU_V9_REG_2(0x0247,0x0267).time = unsigned(1.0 / 491.52 * us);
    RFU_V9_W_2(0x0247,0x0267);
    return 0;
}
...
int32_t ns_sp9500x::dma_mgr::get_fpga_w_timeout_time(uint32_t &us) const
{
    ...
    RFU_V9_R_2(0x0247,0x0267);
    us = RFU_V9_REG_2(0x0247,0x0267).time * 49152 / 100;
    return 0;
}
...
int32_t ns_sp9500x::dma_mgr::is_fpga_w_timeout(bool &timeout) const
{
    ...
    RFU_V9_R_2(0x0247,0x0267);
    timeout = RFU_V9_REG_2(0x0247,0x0267).timeout;
    return 0;
}
