...
public:
    ...
    virtual int32_t set_io_mode(const ns_sp1403::port_t port,const io_mode_t mode);
    ...
    virtual int32_t set_rx_bw(const rx_bw_t bw) const { return set_rx_sw4(bw); }
    virtual int32_t get_rx_bw(rx_bw_t &bw) const { return get_rx_sw4(bw); }
