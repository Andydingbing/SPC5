...
class RD_API arb_producer : boost::noncopyable
{
public:
...
class RD_API arb_producer_file : public arb_producer
{
public:
...
class RD_API arb_producer_const : public arb_producer
{
public:
...
class RD_API arb_producer_increment : public arb_producer
{
public:
    int32_t load(const char *arg,ns_arb::param_t &param);
    void produce(const uint32_t begin,const uint32_t samples,uint32_t *buf);
...
class RD_API arb_mgr : boost::noncopyable
{
public:
