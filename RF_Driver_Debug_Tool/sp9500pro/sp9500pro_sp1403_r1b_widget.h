...
private slots:
    ...
    { SP1403_R1B->set_att(sp1403_r1a::TX0_ATT0,index / 4.0); }

    void on_comboBoxTX1Att0_activated(int index)
    { SP1403_R1B->set_att(sp1403_r1a::TX1_ATT0,index / 4.0); }

    void on_comboBoxTX0Att1_activated(int index)
    { SP1403_R1B->set_att(sp1403_r1a::TX0_ATT1,index / 4.0); }

    void on_comboBoxTX1Att1_activated(int index)
    { SP1403_R1B->set_att(sp1403_r1a::TX1_ATT1,index / 4.0); }

    void on_comboBoxTX0Att2_activated(int index)
    { SP1403_R1B->set_att(sp1403_r1a::TX0_ATT2,index / 4.0); }

    void on_comboBoxTX1Att2_activated(int index)
    { SP1403_R1B->set_att(sp1403_r1a::TX1_ATT2,index / 4.0); }

    void on_comboBoxTX0Att3_activated(int index)
    { SP1403_R1B->set_att(sp1403_r1a::TX0_ATT3,index / 4.0); }

    void on_comboBoxTX1Att3_activated(int index)
    { SP1403_R1B->set_att(sp1403_r1a::TX1_ATT3,index / 4.0); }
