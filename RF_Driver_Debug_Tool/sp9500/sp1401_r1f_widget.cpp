...
#include "ui_sp1401_r1f.h"

using namespace rd;
using namespace rd::ns_sp1401;
using namespace rd::ns_sp1401::r1f;

Q_SP1401_R1F_Widget::Q_SP1401_R1F_Widget(QWidget *parent) :
    Q_RD_Widget(parent),
    ui(new Ui::Q_SP1401_R1F_Widget)
{
    ui->setupUi(this);
...
Q_SP1401_R1F_Widget::~Q_SP1401_R1F_Widget()
{
    delete ui;
}

void Q_SP1401_R1F_Widget::on_lineEditTXFreq_returnPressed()
{
    RD_TRY
...
void Q_SP1401_R1F_Widget::on_comboBoxIOMode_activated(int index)
{
    SP1401_R1F->set_io_mode(io_mode_t(index));
}

void Q_SP1401_R1F_Widget::on_lineEditDGain_textChanged(const QString &arg1)
{
...
void Q_SP1401_R1F_Widget::on_lineEditRXFreq_returnPressed()
{
    RD_TRY
...
void Q_SP1401_R1F_Widget::on_comboBoxRXLNAAttSw_activated(int index)
{
    SP1401_R1F->set_rx_lna_att_sw(rx_lna_att_t(index));
}

void Q_SP1401_R1F_Widget::on_comboBoxRXAtt019Sw_activated(int index)
{
    SP1401_R1F->set_rx_att_019_sw(rx_att_019_t(index));
}

void Q_SP1401_R1F_Widget::on_comboBoxRXAtt1_activated(int index)
{
    SP1401_R1F->set_rx_att1(index * 0.5);
}

void Q_SP1401_R1F_Widget::on_comboBoxIFFilterSw_activated(int index)
{
    SP1401_R1F->set_rx_if_filter_sw(sp1401::rx_if_filter_t(index));
}

void Q_SP1401_R1F_Widget::on_comboBoxRXAtt2_activated(int index)
{
    SP1401_R1F->set_rx_att2(index * 0.5);
}

void Q_SP1401_R1F_Widget::on_pushButtonSetRXAll_clicked()
{
...
void Q_SP1401_R1F_Widget::on_pushButtonGetTempDetAll_clicked()
{
    double temp[3] = {0.0};
    quint32 det[3] = {0};
...
void Q_SP1401_R1F_Widget::on_pushButtonSetSN_clicked()
{
    quint32 ordinal = ui->lineEditOrdinal->text().toUInt();
    SP1401_R1F->set_sn_major(R1F,ordinal);
}

void Q_SP1401_R1F_Widget::on_pushButtonGetSN_clicked()
{
    char sn[32] = {0};
