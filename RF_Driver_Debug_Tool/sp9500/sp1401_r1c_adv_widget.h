#ifndef Q_SP1401_R1C_ADV_WIDGET_H
#define Q_SP1401_R1C_ADV_WIDGET_H
...
class Q_SP1401_R1C_Adv_Widget : public Q_RD_Widget
{
    Q_OBJECT

public:
    explicit Q_SP1401_R1C_Adv_Widget(QWidget *parent = nullptr);
...
#endif // Q_SP1401_R1C_ADV_WIDGET_H
