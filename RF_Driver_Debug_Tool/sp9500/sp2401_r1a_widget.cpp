...
void Q_SP2401_R1A_Widget::on_pushButtonSetADClock_clicked()
{
    double freq = ui->lineEditADClock->text().toDouble();
    SP2401->set_ad_freq_MHz(freq);
}

void Q_SP2401_R1A_Widget::on_pushButtonSetADSw_clicked()
{
    sp2401_r1a::ad_da_port_t port = (sp2401_r1a::ad_da_port_t)(ui->comboBoxDASw->currentIndex());
    SP2401->set_ad_sw(port);
}

void Q_SP2401_R1A_Widget::on_pushButtonSetDDC_clicked()
{
    double freq = freq_string_to_double(ui->lineEditDDC->text().toStdString());
    SP2401->set_ddc(freq);
}

void Q_SP2401_R1A_Widget::on_pushButtonGetManualPower_clicked()
{
    on_pushButtonGetADManual_clicked();
}

void Q_SP2401_R1A_Widget::on_pushButtonGetADManual_clicked()
{
    int64_t ad = 0;
...
void Q_SP2401_R1A_Widget::on_pushButtonGetADFPGA_clicked()
{
    int64_t ad = 0;
...
void Q_SP2401_R1A_Widget::on_pushButtonSetRxPowerComp_clicked()
{
    SP2401->set_rx_pwr_comp(ui->lineEditRxPowerComp->text().toInt());
}

void Q_SP2401_R1A_Widget::on_pushButtonSetRxFilter_clicked()
{
...
void Q_SP2401_R1A_Widget::on_lineEditIQPhaseI_textEdited(const QString &arg1)
{
    SP2401->set_tx_phase_rotate_I(ui->lineEditIQPhaseI->text().toDouble());
}

void Q_SP2401_R1A_Widget::on_lineEditIQAmpI_textEdited(const QString &arg1)
{
...
void Q_SP2401_R1A_Widget::on_lineEditIQAmpQ_textEdited(const QString &arg1)
{
    SP2401->set_tx_amplitude_balance(
                ui->lineEditIQAmpI->text().toUShort(),
                ui->lineEditIQAmpQ->text().toUShort());
...
void Q_SP2401_R1A_Widget::on_lineEditDCOffsetI_textEdited(const QString &arg1)
{
...
void Q_SP2401_R1A_Widget::on_lineEditDCOffsetQ_textEdited(const QString &arg1)
{
    SP2401->set_tx_dc_offset(
...
void Q_SP2401_R1A_Widget::on_lineEditDUC_textEdited(const QString &arg1)
{
    SP2401->set_duc_dds( ui->lineEditDUC->text().toDouble()*1000000);
}

void Q_SP2401_R1A_Widget::on_lineEditDDS1_textEdited(const QString &arg1)
{
    SP2401->set_dds1(ui->lineEditDDS1->text().toDouble()*1000000);
}
