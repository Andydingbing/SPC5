...
Q_SP1401_R1A_Adv_Widget::Q_SP1401_R1A_Adv_Widget(QWidget *parent) :
    Q_RD_Widget(parent),
    ui(new Ui::Q_SP1401_R1A_Adv_Widget)
{
    ui->setupUi(this);
    ...
    ui->comboBoxIOMode->setCurrentIndex(int(rd::OUTPUT));
...
Q_SP1401_R1A_Adv_Widget::~Q_SP1401_R1A_Adv_Widget()
{
    delete ui;
}

void Q_SP1401_R1A_Adv_Widget::on_comboBoxTxIOSw_activated(int index)
{
    SP1401_R1A->set_tx_io_sw(sp1401_r1a::tx_io_sw_t(ui->comboBoxTxIOSw->currentIndex()));
}

void Q_SP1401_R1A_Adv_Widget::on_comboBoxTxAtt3_activated(int index)
{
    SP1401_R1A->set_tx_att3(ui->comboBoxTxAtt3->currentIndex() * 10);
}

void Q_SP1401_R1A_Adv_Widget::on_comboBoxTxPAAttSw_activated(int index)
{
    SP1401_R1A->set_tx_pa_att_sw(tx_pa_att_t(ui->comboBoxTxPAAttSw->currentIndex()));
}

void Q_SP1401_R1A_Adv_Widget::on_comboBoxTxAtt2_activated(int index)
{
    SP1401_R1A->set_tx_att2(ui->comboBoxTxAtt2->currentIndex() * 10);
}

void Q_SP1401_R1A_Adv_Widget::on_comboBoxTxAtt1_activated(int index)
{
    SP1401_R1A->set_tx_att1(ui->comboBoxTxAtt1->currentIndex() * 10);
}

void Q_SP1401_R1A_Adv_Widget::on_comboBoxTxBandSw_activated(int index)
{
    SP1401_R1A->set_tx_band_sw(sp1401_r1a::tx_band_t(ui->comboBoxTxBandSw->currentIndex()));
}

void Q_SP1401_R1A_Adv_Widget::on_pushButtonModEn_clicked()
{
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonPowerOn_clicked()
{
...
void Q_SP1401_R1A_Adv_Widget::on_comboBoxIOMode_activated(int index)
{
    SP1401_R1A->set_io_mode(io_mode_t(ui->comboBoxIOMode->currentIndex()));
}

void Q_SP1401_R1A_Adv_Widget::on_checkBoxTxLED_clicked()
{
...
void Q_SP1401_R1A_Adv_Widget::on_checkBoxRxLED_clicked()
{
    bool txLED = ui->checkBoxTxLED->isChecked();
    bool rxLED = ui->checkBoxRxLED->isChecked();
    SP1401_R1A->set_led(txLED,rxLED);
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonSetTxFreq_clicked()
{

}

void Q_SP1401_R1A_Adv_Widget::on_pushButtonSetRxFreq_clicked()
{

}

void Q_SP1401_R1A_Adv_Widget::on_pushButtonGetTxTemp_clicked()
{
    double temp = 0.0;
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonGetRxTemp_clicked()
{
    double temp = 0.0;
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonGetTxDet_clicked()
{
    uint32_t det = 0;
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonGetRxDet_clicked()
{
    uint32_t det = 0;
...
void Q_SP1401_R1A_Adv_Widget::on_comboBoxRxIOSw1_activated(int index)
{
    SP1401_R1A->set_rx_io_sw1(sp1401_r1a::rx_io_sw1_t(ui->comboBoxRxIOSw1->currentIndex()));
}

void Q_SP1401_R1A_Adv_Widget::on_comboBoxRxIOSw2_activated(int index)
{
    SP1401_R1A->set_rx_io_sw2(sp1401_r1a::rx_io_sw2_t(ui->comboBoxRxIOSw2->currentIndex()));
}

void Q_SP1401_R1A_Adv_Widget::on_comboBoxRxIOSw_activated(int index)
{
    SP1401_R1A->set_rx_io_sw(sp1401_r1a::rx_io_sw_t(ui->comboBoxRxIOSw->currentIndex()));
}

void Q_SP1401_R1A_Adv_Widget::on_comboBoxRxLNAAttSw_activated(int index)
{
    SP1401_R1A->set_rx_lna_att_sw(rx_lna_att_t(ui->comboBoxRxLNAAttSw->currentIndex()));
}

void Q_SP1401_R1A_Adv_Widget::on_comboBoxRxAtt1_activated(int index)
{
    SP1401_R1A->set_rx_att1(ui->comboBoxRxAtt1->currentIndex() * 0.5);
}

void Q_SP1401_R1A_Adv_Widget::on_comboBoxRxAtt2_activated(int index)
{
    SP1401_R1A->set_rx_att2(ui->comboBoxRxAtt2->currentIndex() * 10);
}

void Q_SP1401_R1A_Adv_Widget::on_comboBoxIFFilterSw_activated(int index)
{
    SP1401_R1A->set_rx_if_filter_sw(sp1401::rx_if_filter_t(ui->comboBoxIFFilterSw->currentIndex()));
}

void Q_SP1401_R1A_Adv_Widget::on_pushButtonAdvTxLO1_clicked()
{
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonAdvTxLO2_clicked()
{
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonAdvRxLO1_clicked()
{
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonAdvRxLO2_clicked()
{
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonSetTxLO1_clicked()
{
    uint64_t freq = 0;
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonSetTxLO2_clicked()
{
    uint64_t freq = 0;
    quint64 freqLO1 = freq_string_to<quint64>(ui->lineEditTxLO1->text().toStdString());
    quint64 freqLO2 = freq_string_to<quint64>(ui->lineEditTxLO2->text().toStdString());
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonSetRxLO1_clicked()
{
    uint64_t freq = 0;
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonSetRxLO2_clicked()
{
    uint64_t freq = 0;
    quint64 freqLO1 = freq_string_to<quint64>(ui->lineEditRxLO1->text().toStdString());
    quint64 freqLO2 = freq_string_to<quint64>(ui->lineEditRxLO2->text().toStdString());
