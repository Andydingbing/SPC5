#ifndef Q_SP1401_R1C_WIDGET_H
#define Q_SP1401_R1C_WIDGET_H

#include "global.h"

class Q_SP1401_R1C_Widget : public Q_RD_Widget
{
    Q_OBJECT

public:
    explicit Q_SP1401_R1C_Widget(QWidget *parent = nullptr);
    ~Q_SP1401_R1C_Widget();
...
private slots:
    ...
    void on_comboBoxIOMode_activated(int index) { SP1401_R1C->set_io_mode(io_mode_t(index)); }
