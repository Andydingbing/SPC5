...
Q_SP1401_R1C_Adv_Widget::Q_SP1401_R1C_Adv_Widget(QWidget *parent) :
    Q_RD_Widget(parent),
    ui(new Ui::Q_SP1401_R1C_Adv_Widget)
{
    ui->setupUi(this);
...
Q_SP1401_R1C_Adv_Widget::~Q_SP1401_R1C_Adv_Widget()
{
    delete ui;
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxTXIOSw2_activated(int index)
{
    SP1401_R1C->set_tx_io_sw2(sp1401_r1c::tx_io_sw2_t(index));
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxTXIOSw1_activated(int index)
{
    SP1401_R1C->set_tx_io_sw1(sp1401_r1c::tx_io_sw1_t(index));
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxTXAtt3_activated(int index)
{
    SP1401_R1C->set_tx_att3(index * 0.5);
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxTXAtt2_activated(int index)
{
    SP1401_R1C->set_tx_att2(index * 0.5);
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxTXAtt1_activated(int index)
{
    SP1401_R1C->set_tx_att1(index * 0.5);
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxTXFilterSw1_activated(int index)
{
    Q_UNUSED(index);
...
void Q_SP1401_R1C_Adv_Widget::on_comboBoxTXFilterSw2_activated(int index)
{
    Q_UNUSED(index);
...
void Q_SP1401_R1C_Adv_Widget::on_comboBoxTXAtt0_activated(int index)
{
    SP1401_R1C->set_tx_att0(index * 0.5);
}

void Q_SP1401_R1C_Adv_Widget::on_pushButtonModEn_clicked()
{
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonPowerOn_clicked()
{
...
void Q_SP1401_R1C_Adv_Widget::on_comboBoxLoopSw_activated(int index)
{
    SP1401_R1C->set_loop_sw(sp1401_r1c::loop_sw_t(index));
}

void Q_SP1401_R1C_Adv_Widget::on_pushButtonSetTXLO3_clicked()
{
    RD_TRY
    uint64_t freq = 0;
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonSetTXLO2_clicked()
{
    RD_TRY
    uint64_t freq = 0;
    quint64 freqLO1 = freq_string_to_uint64_t(ui->lineEditTXLO1->text().toStdString());
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonSetTXLO1_clicked()
{
    RD_TRY
    uint64_t freq = 0;
    quint64 freqLO1 = freq_string_to_uint64_t(ui->lineEditTXLO1->text().toStdString());
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonSetRXLO1_clicked()
{
    RD_TRY
    uint64_t freq = 0;
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonAdvTXLO3_clicked()
{
    quint8 dlgIdx = 1;
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonAdvTXLO2_clicked()
{
    quint8 dlgIdx = 0;
    if (dlg_ADF5355[dlgIdx] == nullptr) {
        dlg_ADF5355[dlgIdx] = new Q_ADF5355_Dlg;
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonAdvTXLO1_clicked()
{

}

void Q_SP1401_R1C_Adv_Widget::on_pushButtonAdvRXLO1_clicked()
{
    quint8 dlgIdx = 2;
    if (dlg_ADF5355[dlgIdx] == nullptr) {
        dlg_ADF5355[dlgIdx] = new Q_ADF5355_Dlg;
...
void Q_SP1401_R1C_Adv_Widget::on_comboBoxIOMode_activated(int index)
{
    SP1401_R1C->set_io_mode(io_mode_t(index));
}

void Q_SP1401_R1C_Adv_Widget::on_checkBoxTXLED_clicked(bool checked)
{
    Q_UNUSED(checked);
...
void Q_SP1401_R1C_Adv_Widget::on_checkBoxRXLED_clicked(bool checked)
{
    Q_UNUSED(checked);
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonSetTXFreq_clicked()
{
    RD_TRY
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonSetRXFreq_clicked()
{
    RD_TRY
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonGetAllTemp_clicked()
{
    double temp[8] = {0.0};
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonGetAllDet_clicked()
{
...
void Q_SP1401_R1C_Adv_Widget::on_comboBoxRXIOSw1_activated(int index)
{
    SP1401_R1C->set_rx_io_sw1(sp1401_r1c::rx_io_sw1_t(index));
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxRXIOSw2_activated(int index)
{
    SP1401_R1C->set_rx_io_sw2(sp1401_r1c::rx_io_sw2_t(index));
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxRXIOSw3_activated(int index)
{
    SP1401_R1C->set_rx_io_sw3(sp1401_r1c::rx_io_sw3_t(index));
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxLNAAttSw_activated(int index)
{
    SP1401_R1C->set_rx_lna_att_sw(rx_lna_att_t(index));
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxAtt019Sw_activated(int index)
{
    SP1401_R1C->set_rx_att_019_sw(rx_att_019_t(index));
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxRXAtt1_activated(int index)
{
    SP1401_R1C->set_rx_att1(index * 0.5);
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxRXAtt2_activated(int index)
{
    SP1401_R1C->set_rx_att2(index * 0.5);
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxIFFilterSw_activated(int index)
{
    SP1401_R1C->set_rx_if_filter_sw(sp1401_r1c::rx_if_filter_t(index));
}

void Q_SP1401_R1C_Adv_Widget::on_comboBoxRXAtt3_activated(int index)
{
