...
Q_SP1401_R1C_Widget::~Q_SP1401_R1C_Widget()
{
    delete ui;
}

void Q_SP1401_R1C_Widget::on_lineEditTXFreq_returnPressed()
{
    RD_TRY
...
void Q_SP1401_R1C_Widget::on_lineEditDGain_textEdited(const QString &arg1)
{
...
void Q_SP1401_R1C_Widget::on_pushButtonSetTXAll_clicked()
{
    double att0 = ui->comboBoxTXAtt0->currentIndex() * 0.5;
    double att1 = ui->comboBoxTXAtt1->currentIndex() * 0.5;
    double att2 = ui->comboBoxTXAtt2->currentIndex() * 0.5;
...
void Q_SP1401_R1C_Widget::on_lineEditRXFreq_returnPressed()
{
    RD_TRY
...
void Q_SP1401_R1C_Widget::on_pushButtonSetRXAll_clicked()
{
...
void Q_SP1401_R1C_Widget::on_pushButtonGetTempAll_clicked()
{
    double temp[8] = {0.0};
...
void Q_SP1401_R1C_Widget::on_pushButtonGetDetAll_clicked()
{
    quint32 det[4] = {0};
...
void Q_SP1401_R1C_Widget::on_pushButtonSetSN_clicked()
{
...
void Q_SP1401_R1C_Widget::on_pushButtonGetSN_clicked()
{
    char sn[32] = {0};
