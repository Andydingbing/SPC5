...
public:
    sp1401::bw_t get_bw() const { return m_cal_file->bw(); }

    sp1401::hw_ver_t get_hw_ver() const { return m_cal_file->hw_ver(); }

    void set_hw_ver(sp1401::hw_ver_t ver) { m_cal_file->set_hw_ver(ver); }
    ...
    vi_pci_dev* get_k7() const { return m_k7; }

    void connect(vi_pci_dev *k7) { m_k7 = k7; }
    ...
    static  std::string hw_ver2str(sp1401::hw_ver_t ver);
    static  std::string hw_ver2sn_header(sp1401::hw_ver_t ver);
...
public:
    int32_t set_sn_major(const sp1401::hw_ver_t &ver,const uint32_t &ordinal);
    int32_t get_sn_major(char *sn);
    int32_t set_sn_redundant(const sp1401::sn_redundant_t &info,
                             const std::vector<sp1401::tx_trouble_shoot_t> &tx_ts,
                             const std::vector<sp1401::rx_trouble_shoot_t> &rx_ts,
                             const std::string &remark);
    int32_t get_sn_redundant(sp1401::sn_redundant_t &info,
                             std::vector<sp1401::tx_trouble_shoot_t> &tx_ts,
                             std::vector<sp1401::rx_trouble_shoot_t> &rx_ts,
                             std::string &remark);
