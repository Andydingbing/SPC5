...
// tx lo leakage r1a/b
class RD_API tx_lol_table_r1ab
{
public:
    ...
    DECLARE_CAL_ITEM_TABLE(tx_lol_table_r1ab,RF_TX_FREQ_PTS_CALLED)
public:
    void get(uint64_t freq,int16_t &dc_i,int16_t &dc_q);
};

// tx lo leakage r1c/d
class RD_API tx_lol_table_r1cd
{
public:
    typedef struct RD_API data_f_t : public tx_lol_table_r1ab::data_f_t {
