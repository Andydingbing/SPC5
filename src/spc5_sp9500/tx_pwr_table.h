...
// TX power table R1C/D/E/F.
class RD_API tx_pwr_table_r1c
{
public:
...
public:
    ...
    virtual void get(sp1401::hw_ver_t ver,uint64_t freq,double pwr,data_m_t *data) = 0;
    virtual void get(sp1401::hw_ver_t ver,uint64_t freq,double pwr,data_f_t *data) = 0;
};
...
public: \
    ...
    void get(sp1401::hw_ver_t ver,uint64_t freq,double pwr,data_m_t *data); \
    void get(sp1401::hw_ver_t ver,uint64_t freq,double pwr,data_f_t *data); \
...
class RD_API tx_pwr_op_table_r1c : public tx_pwr_table_r1c
{
    DECLARE_TX_PWR_TABLE_R1C
    DECLARE_CAL_ITEM_TABLE(tx_pwr_op_table_r1c,RF_TX_FREQ_PTS_CALLED)
};

class RD_API tx_pwr_io_table_r1c : public tx_pwr_table_r1c
{
    DECLARE_TX_PWR_TABLE_R1C
    DECLARE_CAL_ITEM_TABLE(tx_pwr_io_table_r1c,RF_TX_FREQ_PTS_CALLED)
};
