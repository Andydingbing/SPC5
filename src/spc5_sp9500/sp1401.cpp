...
boost::function<bool()> basic_sp1401::_ftp_retry_call_back = boost::function<bool()>();

basic_sp1401::basic_sp1401()
{
    m_k7 = nullptr;
    m_arb_reader = boost::make_shared<arb_reader>();
}

int32_t basic_sp1401::open_board()
{
...
int32_t basic_sp1401::get_hw_ver(const char *sn,hw_ver_t &ver)
{
    if (sn[6] == 'R' && sn[7] == '1') {
        if (sn[8] == 'A') { ver = R1A; }
...
string basic_sp1401::hw_ver2str(hw_ver_t ver)
{
    switch (ver) {
        ...
        case HW_MAX   : return string("unknown version");
    }
    return string("unknown version");
}

string basic_sp1401::hw_ver2sn_header(hw_ver_t ver)
{
    switch (ver) {
        ...
        case HW_MAX : return string("SP1401ERR");
    }
    return string("SP1401ERR");
}

int32_t basic_sp1401::get_k7_ver(uint32_t &ver)
{
    RFU_K7_REG_DECLARE(0x0000);
    RFU_K7_R(0x0000);
    ver = RFU_K7_REG_U32(0x0000);
    return 0;
}

int32_t basic_sp1401::set_sn_major(const hw_ver_t &ver,const uint32_t &ordinal)
{
    char sn[32] = {0};
    ZERO_ARRAY(sn);
    ...
    sprintf(sn,"%9s%08XRFU%dRF%d",
            ...
            rfu_idx,
            rf_idx);
    INT_CHECK(w_eeprom(0x0000,RF_SN_LENGTH,sn));
    return 0;
}

int32_t basic_sp1401::set_sn_redundant(const sn_redundant_t &info,
                                       ...
                                       const string &remark)
{
    ...
    uint16_t cur_pos = 0x0000 + RF_SN_LENGTH;
...
int32_t basic_sp1401::get_sn_redundant(sn_redundant_t &info,
                                       ...
                                       string &remark)
{
    ...
    uint64_t cur_pos = 0x0000 + RF_SN_LENGTH;
...
int32_t basic_sp1401::get_sn_major(char *sn)
{
    INT_CHECK(r_eeprom(0x0000,24,sn));
    return 0;
}

uint32_t basic_sp1401::ass_ordinal(uint32_t ordinal)
{
...
int32_t basic_sp1401::is_valid_sn(const char *sn)
{
    int32_t i = 0;
    if (!strcmp(sn,""))
        return SN_NULL;
...
int32_t basic_sp1401::set_arb_segments(uint16_t segs)
{
...
int32_t basic_sp1401::set_arb_param(uint32_t add_samp,uint32_t cycle,uint32_t rep_mode)
{
...
int32_t basic_sp1401::set_arb_trigger(bool retrigger, bool auto_start, uint32_t src, uint32_t trig_delay)
{
...
int32_t basic_sp1401::set_arb_manual_trigger()
{
...
int32_t basic_sp1401::set_arb_bc_star_pos(uint32_t pos)
{
...
int32_t basic_sp1401::set_arb_bc_samples(uint32_t samples)
{
...
uint32_t basic_sp1401::get_arb_current_seg()
{
...
uint32_t basic_sp1401::get_arb_current_sample()
{
...
uint32_t basic_sp1401::get_arb_current_cycle()
{
...
double basic_sp1401::get_arb_current_timer()
{
...
int32_t basic_sp1401::arb_start()
{
...
int32_t basic_sp1401::w_eeprom(uint16_t addr,uint32_t length,const char *buf)
{
...
int32_t basic_sp1401::r_eeprom(uint16_t addr,uint32_t length,char *buf)
{
    RFU_K7_REG_DECLARE_2(0x161d,0x169d);
    RFU_K7_REG_DECLARE_2(0x161e,0x169e);
...
int32_t basic_sp1401::set_pwr_meas_src(pwr_meas_src_t src,bool posedge)
{
...
int32_t basic_sp1401::set_pwr_meas_timeout(uint32_t us)
{
...
int32_t basic_sp1401::is_pwr_meas_timeout(bool &timeout)
{
    RFU_K7_REG_DECLARE_2(0x1063,0x1093);
...
int32_t basic_sp1401::pwr_meas_start()
{
...
int32_t basic_sp1401::pwr_meas_abort()
{
    RFU_K7_REG_DECLARE_2(0x1065,0x1095);
...
int32_t basic_sp1401::set_pwr_meas_samples(uint32_t samples)
{
...
int32_t basic_sp1401::get_pwr_meas_samples(uint32_t &samples)
{
    RFU_K7_REG_DECLARE_2(0x1066,0x1096);
    RFU_K7_R_2(0x1066,0x1096);
    samples = RFU_K7_REG_U32_2(0x1066,0x1096);
    return 0;
}

int32_t basic_sp1401::get_pwr_meas_state(pwr_meas_state_t &state)
{
...
int32_t basic_sp1401::get_pwr_meas_peak(double &pwr)
{
...
int32_t basic_sp1401::get_pwr_meas_pwr(double &pwr)
{
...
int32_t basic_sp1401::get_ads5474(int64_t &ad)
{
...
int32_t basic_sp1401::get_ads5474_manual(int64_t &ad)
{
//     ad = 0;
//     int16_t I[4096] = {0};
//     int16_t Q[4096] = {0};
...
int32_t basic_sp1401::set_rx_if_filter_sw(rx_if_filter_t filter)
{
...
int32_t basic_sp1401::get_ad7680(uint32_t &det)
{
...
int32_t basic_sp1401::ftp_put##report() \
{   ftp ftp_worker("10.10.0.10","",""); \
    ...
    for (uint32_t i = 0;i < 3;i ++) { \
        if (ftp_worker.put(p_host.string(),p_remote.string(),file_name_remote)) { \
            ...
            if (basic_sp1401::_ftp_retry_call_back.empty()) { return -1; } \
            if (basic_sp1401::_ftp_retry_call_back()) continue; \
            else return -1; \
        } \
    } \
    return -1; \
