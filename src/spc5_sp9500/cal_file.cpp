...
uint32_t cal_file::get_fix_item_table_r1ab(item_info_t *info,uint32_t &items)
{
    item_info_t item_info[] = {
        {0xaa,TX_SB,     sizeof(tx_sb_table_r1ab::data_f_t)  ,RF_TX_FREQ_PTS_INFILE,0xff},
        {0xaa,TX_LOL,    sizeof(tx_lol_table_r1ab::data_f_t) ,RF_TX_FREQ_PTS_INFILE,0xff},
        {0xaa,TX_ATT_OP, sizeof(tx_att_table_r1ab::data_f_t) ,RF_TX_FREQ_PTS_INFILE,0xff},
        {0xaa,TX_PWR_OP, sizeof(tx_pwr_table_r1ab::data_f_t) ,RF_TX_FREQ_PTS_INFILE,0xff},
        {0xaa,TX_PWR_IO, sizeof(tx_pwr_table_r1ab::data_f_t) ,RF_TX_FREQ_PTS_INFILE,0xff},
        {0xaa,RX_REF,    sizeof(rx_ref_table_r1ab::data_f_t) ,RF_RX_FREQ_PTS_INFILE,0xff},
        {0xaa,X9119,     sizeof(x9119_table::data_t)		 ,1                    ,0xff},
        {0xaa,TX_ATT_IO, sizeof(tx_att_table_r1ab::data_f_t) ,RF_TX_FREQ_PTS_INFILE,0xff}
	};
...
uint32_t cal_file::get_fix_item_table_r1cd(item_info_t *info,uint32_t &items)
{
    item_info_t item_info[] = {
        ...
        {0xaa,TX_PWR_OP,              sizeof(tx_pwr_op_table_r1c::data_f_t), 	RF_TX_FREQ_PTS_INFILE, 0xff},
        {0xaa,TX_PWR_IO,              sizeof(tx_pwr_io_table_r1c::data_f_t),    RF_TX_FREQ_PTS_INFILE, 0xff},
        {0xaa,TX_ATT_OP,              sizeof(tx_att_op_table_r1cd::data_f_t),   RF_TX_FREQ_PTS_INFILE, 0xff},
        {0xaa,TX_ATT_IO,              sizeof(tx_att_io_table_r1cd::data_f_t),   RF_TX_FREQ_PTS_INFILE, 0xff},
        {0xaa,RX_REF_OP,              sizeof(rx_ref_op_table_r1cd::data_f_t),   RF_RX_FREQ_PTS_INFILE, 0xff},
        {0xaa,RX_REF_IO,              sizeof(rx_ref_io_table_r1cd::data_f_t),   RF_RX_FREQ_PTS_INFILE, 0xff},
        {0xaa,RX_ATT_OP,              sizeof(rx_att_op_table_r1cd::data_f_t),   RF_RX_FREQ_PTS_INFILE, 0xff},
        {0xaa,RX_ATT_IO,              sizeof(rx_att_io_table_r1cd::data_f_t),   RF_RX_FREQ_PTS_INFILE, 0xff},
        {0xaa,TX_FILTER_80,           sizeof(tx_filter_80m_table::data_f_t),    RF_TX_FREQ_PTS_INFILE, 0xff},
        {0xaa,TX_FILTER_160,          sizeof(tx_filter_160m_table::data_f_t),   RF_TX_FREQ_PTS_INFILE, 0xff},
        {0xaa,TX_RF_FR_0,             sizeof(tx_rf_fr_table::data_f_t),         RF_TX_FILTER_PTS_0,	   0xff},
        {0xaa,TX_RF_FR_1,             sizeof(tx_rf_fr_table::data_f_t),         RF_TX_FILTER_PTS_1,	   0xff},
        {0xaa,TX_IF_FR,               sizeof(tx_if_fr_table::data_f_t),         IF_TX_FILTER_160M_PTS, 0xff},
        {0xaa,RX_FILTER_80,           sizeof(rx_filter_80m_table::data_f_t),    RF_RX_FREQ_PTS_INFILE, 0xff},
        {0xaa,RX_FILTER_160,          sizeof(rx_filter_160m_table::data_f_t),   RF_RX_FREQ_PTS_INFILE, 0xff},
        {0xaa,RX_RF_FR,               sizeof(rx_rf_fr_table::data_f_t),         RF_RX_FILTER_PTS,	   0xff},
        {0xaa,RX_IF_FR,               sizeof(rx_if_fr_table::data_f_t),         IF_RX_FILTER_160M_PTS, 0xff},
        {0xaa,TX_FILTER_OFFSET_OP_80, sizeof(tx_filter_offset_table::data_f_t), RF_TX_FREQ_PTS_INFILE, 0xff},
        {0xaa,TX_FILTER_OFFSET_IO_80, sizeof(tx_filter_offset_table::data_f_t), RF_TX_FREQ_PTS_INFILE, 0xff},
        {0xaa,RX_FILTER_OFFSET_OP_80, sizeof(rx_filter_offset_table::data_f_t),	RF_RX_FREQ_PTS_INFILE, 0xff},
        {0xaa,RX_FILTER_OFFSET_IO_80, sizeof(rx_filter_offset_table::data_f_t),	RF_RX_FREQ_PTS_INFILE, 0xff}
	};
    items = ARRAY_SIZE(item_info);
    for (uint32_t i = 0;i < items;i ++)
        info[i] = item_info[i];
