...
int32_t cal_file_r1cd::add(cal_item_t item,void *data)
{
    ...
    switch (item) {
        ...
        case cal_file::TX_PWR_OP     : ADD_DATAF(m_tx_pwr_op,tx_pwr_op_table_r1c::data_f_t);
        case cal_file::TX_PWR_IO     : ADD_DATAF(m_tx_pwr_io,tx_pwr_io_table_r1c::data_f_t);
...
int32_t cal_file_r1cd::map2buf(cal_item_t item)
{
    ...
    if (item != g_cal_item_buf.item || this->m_rf_idx != g_cal_item_buf.rf_idx || this->m_rfu_idx != g_cal_item_buf.rfu_idx) {
        ...
        switch (item) {
            ...
            case cal_file::TX_PWR_OP : MAP_GLOBAL_DATAF(m_tx_pwr_op,tx_pwr_op_table_r1c::data_f_t);
            case cal_file::TX_PWR_IO : MAP_GLOBAL_DATAF(m_tx_pwr_io,tx_pwr_io_table_r1c::data_f_t);
