...
{
    double real[RX_FILTER_ORDER_2I3D] = {
    ...
    double imag[RX_FILTER_ORDER_2I3D] = {
...
int32_t sp2401_r1a::set_tx_phase_rotate_I(double th)
{
    ...
    RFU_K7_REG_2(0x006a,0x206a).cos = uint16_t(cos(ANGLE_TO_RADIAN(th)) * 16384);
    RFU_K7_REG_2(0x006a,0x206a).sin = uint16_t(sin(ANGLE_TO_RADIAN(th)) * 16384);
...
int32_t sp2401_r1a::set_frame_trig_offset(int32_t offset)
{
    ...
    RFU_K7_R(0x10ca);
    RFU_K7_REG(0x10ca).trigg_offset = offset;
    RFU_K7_W(0x10ca);
    return 0;
}
