...
RD_INLINE uint32_t reg0(
    uint32_t _int,
    uint32_t prescaler,
    uint32_t autocal)
{ return (0 | (_int << 4) | (prescaler << 20) | (autocal << 21)); }

RD_INLINE uint32_t reg1(uint32_t _frac1)
{ return (1 | (_frac1 << 4)); }

RD_INLINE uint32_t reg2(
    uint32_t _mod2,
    uint32_t _frac2)
{ return (2 | (_mod2 << 4) | (_frac2 << 18)); }

RD_INLINE uint32_t reg3(
...
RD_INLINE uint32_t reg5()
{ return 0x00800025; }

RD_INLINE uint32_t reg6(
...
RD_INLINE uint32_t reg8()
{ return 0x102d0428; }

RD_INLINE uint32_t reg9(
...
RD_INLINE uint32_t reg11()
{ return 0x0061300b; }

RD_INLINE uint32_t reg12(uint32_t resync_clock)
{
