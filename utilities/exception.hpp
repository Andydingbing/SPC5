...
DECL_RD_EXCEPTION(assertion_error, exception, "AssertionError")

// Raised when a key or index is invalid.
DECL_RD_EXCEPTION(lookup_error, exception, "LookupError")
// Raised when a key or index is invalid.
...
DECL_RD_EXCEPTION(type_error, exception, "TypeError")

// Raised when an argument has the right type but invalid value.
DECL_RD_EXCEPTION(value_error, exception, "ValueError")
...
DECL_RD_EXCEPTION(runtime_error, exception, "RuntimeError")

// Base class for errors that occur outside of UHD.
DECL_RD_EXCEPTION(environment_error, exception, "EnvironmentError")
