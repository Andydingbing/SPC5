...
template <typename T> RD_INLINE void normal_notation(const std::string &str,T &out)
{ floating_point_numbers_t::normal_notation<T>(str,out); }

template <typename T> RD_INLINE void scientific_notation(const std::string &str,T &out)
{ floating_point_numbers_t::scientific_notation<T>(str,out); }

template <typename T> RD_INLINE void non_unit_notation(const std::string &str,T &out)
{ floating_point_numbers_t::non_unit_notation<T>(str,out); }

template <typename T> RD_INLINE void auto_notation(const std::string &str,T &out)
