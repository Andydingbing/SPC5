...
#include "ui_qcalr1ctxsbdlg.h"
#include "mainwindow.h"
#include "qcalr1ctxsbthread.h"

IMPLEMENT_CAL_R1C_DLG(QCalR1CTxSBDlg,QCalR1CTxSBThread,QExportR1CTxSBThread)

QCalR1CTxSBDlg::QCalR1CTxSBDlg(QWidget *parent) :
    QCalR1CBaseDlg(parent),
    ui(new Ui::QCalR1CTxSBDlg)
{
    ui->setupUi(this);
    _model->append(new QR1CTxSBModel(this));
...
{
    QR1CTxSBModel *model = (QR1CTxSBModel *)(_model->at(0));
...
CalParam QCalR1CTxSBDlg::ui2CalParam()
{
    CalParam p;
    p.parent = this;
    ...
    p.methodSB   = ui->radioButtonSpec->isChecked() ? CalParam::M_Spectrum : CalParam::M_Loopback;
    return p;
}
