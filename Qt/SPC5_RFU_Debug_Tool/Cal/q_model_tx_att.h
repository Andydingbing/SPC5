...
public:
    ...
    explicit QR1CTXAttModel(basic_sp1401 *sp1401, QObject *parent) :
...
public:
    ...
    void resetData()
    {
        QVector<Qwt_Data_T *>::const_iterator ptrIter;
    ...
    void setSP1401(basic_sp1401 *sp1401) { _sp1401 = sp1401; }
...
public:
    ...
    explicit QR1CTXAttOPModel(basic_sp1401 *sp1401, QObject *parent) :
...
public:
    ...
    explicit QR1CTXAttIOModel(basic_sp1401 *sp1401, QObject *parent) :
        QR1CTXAttModel(sp1401,parent) {}
