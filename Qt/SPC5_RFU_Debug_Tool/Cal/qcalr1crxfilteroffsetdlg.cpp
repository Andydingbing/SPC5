...
#include "ui_qcalr1crxfilteroffsetdlg.h"
#include "qcalr1crxfilteroffsetthread.h"
#include "qrdttableview.h"
#include "qcalplot.h"

IMPLEMENT_CAL_R1C_DLG(QCalR1CRxFilterOffsetDlg,QCalR1CRxFilterOffsetThread,QExportR1CRxFilterOffsetThread)

QCalR1CRxFilterOffsetDlg::QCalR1CRxFilterOffsetDlg(QWidget *parent) :
    QCalR1CBaseDlg(parent),
    ui(new Ui::QCalR1CRxFilterOffsetDlg)
{
    ui->setupUi(this);

    _model->append(new QR1CRxFilterOffsetModel(this));
    _model->append(new QR1CRxFilterOffsetModel(this));
    ui->tabWidget->init((QR1CRxFilterOffsetModel *)(_model->at(0)),(QR1CRxFilterOffsetModel *)(_model->at(1)));
...
QCalR1CRxFilterOffsetDlg::~QCalR1CRxFilterOffsetDlg()
{
    delete ui;
}
...
CalParam QCalR1CRxFilterOffsetDlg::ui2CalParam()
{
    CalParam p;
    p.parent = this;
