    ...
    modelIO(nullptr)
{
    ...
    plotDGain->init(RF_TX_FREQ_STAR / 1e6,RF_TX_FREQ_STOP / 1e6,R1C_DGAIN_MIN + 2.0,R1C_DGAIN_MAX - 5.0);
...
void QCalR1CTXPwrWidget::resetShowWidget(CalParam *param)
{
    ...
    QCalR1CTXPwrDlg *parentDlg = dynamic_cast<QCalR1CTXPwrDlg *>(parent());
    hw_ver_t RFVer = parentDlg->SP1401->get_hw_ver();
