...
{
    DECLARE_CAL_QWT_DATA(QwtRxAttOPData)
...
{
    DECLARE_CAL_QWT_DATA(QwtRxAttIOData)
...
public:
    explicit QR1CRxAttOPModel(sp1401_r1c *sp1401, QObject *parent = 0);
...
public:
    explicit QR1CRxAttIOModel(sp1401_r1c *sp1401, QObject *parent = 0);
