...
#include "ui_qcalr1crxattdlg.h"
#include "qcalr1crxattthread.h"
#include "qcalplot.h"
#include "qrdttableview.h"

IMPLEMENT_CAL_R1C_DLG(QCalR1CRxAttDlg,QCalR1CRxAttThread,QExportR1CRxAttThread)

QCalR1CRxAttDlg::QCalR1CRxAttDlg(QWidget *parent) :
    QCalR1CBaseDlg(parent),
    ui(new Ui::QCalR1CRxAttDlg)
{
    ui->setupUi(this);
    _model->append(new QR1CRxAttOPModel(_sp1401,this));
    _model->append(new QR1CRxAttIOModel(_sp1401,this));
    ui->tabWidget->init((QR1CRxAttOPModel *)(_model->at(0)),(QR1CRxAttIOModel *)(_model->at(1)));
...
QCalR1CRxAttDlg::~QCalR1CRxAttDlg()
{
    delete ui;
}
...
{
    ((QR1CRxAttOPModel *)(_model->at(0)))->setSP1401(_sp1401);
    ((QR1CRxAttIOModel *)(_model->at(1)))->setSP1401(_sp1401);
...
CalParam QCalR1CRxAttDlg::ui2CalParam()
{
    CalParam p;
    p.parent = this;
