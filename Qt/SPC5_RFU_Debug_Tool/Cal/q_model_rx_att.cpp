...
QR1CRxAttOPModel::QR1CRxAttOPModel(basic_sp1401 *sp1401, QObject *parent)
    : QCalBaseModel(parent)
    , _sp1401(sp1401)
{
    init ();
...
void QR1CRxAttOPModel::setSP1401(basic_sp1401 *sp1401)
{
    _sp1401 = sp1401;
}
...
QR1CRxAttIOModel::QR1CRxAttIOModel(basic_sp1401 *sp1401, QObject *parent)
    : QCalBaseModel(parent)
    , _sp1401(sp1401)
{
    init();
...
void QR1CRxAttIOModel::setSP1401(basic_sp1401 *sp1401)
{
    _sp1401 = sp1401;
}
