...
DECLARE_TROUBLE_SHOOT_MODEL(QTxTroubleShootModel, txTroubles, tx_trouble_shoot_item, TX_TS_BEGIN, TX_TS_MAX)
DECLARE_TROUBLE_SHOOT_MODEL(QRxTroubleShootModel, rxTroubles, rx_trouble_shoot_item, RX_TS_BEGIN, RX_TS_MAX)
