...
#include "ui_qadf5355dlg.h"

QAdf5355Dlg::QAdf5355Dlg(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::QAdf5355Dlg)
{
    ui->setupUi(this);
...
QAdf5355Dlg::~QAdf5355Dlg()
{
    delete ui;
}

void QAdf5355Dlg::param2Reg(uint32_t *reg)
{
    uint64_t vcoFreq = 0;
    uint64_t refFreq = 0;
    uint32_t _INT = 0;
    ...
    str2freq(ui->lineEditVCOFreq->text().toStdString().c_str(),vcoFreq);
    str2freq(ui->lineEditRefFreq->text().toStdString().c_str(),refFreq);
    if (!(vcoFreq <=0 || refFreq <= 0))
        adf5355_freq_formula(vcoFreq,uint32_t(refFreq),refDoubler,refDivider,rCounter,ADF5355_FREQ_SPACE,_INT,_FRAC1,_FRAC2,_MOD1,_MOD2);

    ui->lineEditINT->setText(QString("%1").arg(_INT));
    ui->lineEditFRAC1->setText(QString("%1").arg(_FRAC1));
    ui->lineEditFRAC2->setText(QString("%1").arg(_FRAC2));
    ui->lineEditMOD1->setText(QString("%1").arg(_MOD1));
    ui->lineEditMOD2->setText(QString("%1").arg(_MOD2));

    uint32_t prescaler = ui->comboBoxPrescaler->currentIndex();
    uint32_t autoCal = ui->checkBoxAutoCal->isChecked() ? 1 : 0;
    reg[0] = adf5355para2reg0(_INT,prescaler,autoCal);
    ...
    reg[4] = adf5355para2reg4(counterReset,cpThreeState,powerDown,pdPolarity,muxLogic,refMode,currentSet,doubleBuff,rCounter,RDIV2,refDoubler,muxOut);
    ...
    reg[6] = adf5355para2reg6(rfOutputPower,rfOutA,rfOutB,MTLD,cpBC,rfDividerSel,feedbackSel,negativeBleed,gatedBleed);
...
void QAdf5355Dlg::param2RegR()
{
    uint32_t reg[13] = {0};
    for (qint8 i = 0;i < ARRAY_SIZE(reg);i ++)
        reg[i] = 0;
...
void QAdf5355Dlg::regW2Reg(uint32_t *reg)
{
...
void QAdf5355Dlg::on_pushButton_14_clicked()
{
    uint32_t reg[13] = {0};
    for (qint8 i = 0;i < ARRAY_SIZE(reg);i ++)
        reg[i] = 0;
...
void QAdf5355Dlg::on_pushButtonCopyTo0_clicked()
{
    ui->lineEditRegW0->setText(ui->lineEditRegR0->text());
}

void QAdf5355Dlg::on_pushButtonCopyTo1_clicked()
{
    ui->lineEditRegW1->setText(ui->lineEditRegR1->text());
}

void QAdf5355Dlg::on_pushButtonCopyTo2_clicked()
{
    ui->lineEditRegW2->setText(ui->lineEditRegR2->text());
}

void QAdf5355Dlg::on_pushButtonCopyTo3_clicked()
{
    ui->lineEditRegW3->setText(ui->lineEditRegR3->text());
}

void QAdf5355Dlg::on_pushButtonCopyTo4_clicked()
{
    ui->lineEditRegW4->setText(ui->lineEditRegR4->text());
}

void QAdf5355Dlg::on_pushButtonCopyTo5_clicked()
{
    ui->lineEditRegW5->setText(ui->lineEditRegR5->text());
}

void QAdf5355Dlg::on_pushButtonCopyTo6_clicked()
{
    ui->lineEditRegW6->setText(ui->lineEditRegR6->text());
}

void QAdf5355Dlg::on_pushButtonCopyTo7_clicked()
{
    ui->lineEditRegW7->setText(ui->lineEditRegR7->text());
}

void QAdf5355Dlg::on_pushButtonCopyTo8_clicked()
{
    ui->lineEditRegW8->setText(ui->lineEditRegR8->text());
}

void QAdf5355Dlg::on_pushButtonCopyTo9_clicked()
{
    ui->lineEditRegW9->setText(ui->lineEditRegR9->text());
}

void QAdf5355Dlg::on_pushButtonCopyTo10_clicked()
{
    ui->lineEditRegW10->setText(ui->lineEditRegR10->text());
}

void QAdf5355Dlg::on_pushButtonCopyTo11_clicked()
{
    ui->lineEditRegW11->setText(ui->lineEditRegR11->text());
}

void QAdf5355Dlg::on_pushButtonCopyTo12_clicked()
{
    ui->lineEditRegW12->setText(ui->lineEditRegR12->text());
}

void QAdf5355Dlg::on_lineEditVCOFreq_textChanged(const QString &arg1)
{
    param2RegR();
}

void QAdf5355Dlg::on_lineEditRefFreq_textChanged(const QString &arg1)
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxRefDoubler_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxRefDivider_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_lineEditRCounter_textChanged(const QString &arg1)
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxPrescaler_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxAutoCal_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_lineEditPhaseValue_textChanged(const QString &arg1)
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxPhaseAjust_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxPhaseResync_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxSDLoadReset_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxCounterReset_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxCPThreeState_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxPowerDown_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxPDPolarity_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxMuxLogic_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxRefMode_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxCurrentSetting_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxDoubleBuff_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxRDIV2_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxMuxOut_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxRfOutputPower_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxRfOutA_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxRfOutB_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxMTLD_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_lineEditCPBleedCurrent_textChanged(const QString &arg1)
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxRfDividerSel_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxFeedbackSel_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxNegativeBleed_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxGateBleed_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxLDMode_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxFracN_LDPrecision_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxLOLMode_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxLDCycleCount_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxLeSync_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxSynthesizerLockTimeout_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_comboBoxAutomaticLevelTimeout_currentIndexChanged(int index)
{
    param2RegR();
}

void QAdf5355Dlg::on_lineEditTimeout_textChanged(const QString &arg1)
{
    param2RegR();
}

void QAdf5355Dlg::on_lineEditVCOBandDivision_textChanged(const QString &arg1)
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxADCEnable_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_checkBoxADCConversion_clicked()
{
    param2RegR();
}

void QAdf5355Dlg::on_lineEditADCClockDivider_textChanged(const QString &arg1)
{
    param2RegR();
}

void QAdf5355Dlg::on_lineEditResyncClock_textChanged(const QString &arg1)
{
    param2RegR();
}
