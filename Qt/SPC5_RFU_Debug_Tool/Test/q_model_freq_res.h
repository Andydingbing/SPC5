...
typedef QwtFreqResData<rf_tx_freq_res_test,rf_tx_freq_res_test_data> QwtRF_TX_FreqResData;
typedef QwtFreqResData<if_tx_freq_res_test,if_tx_freq_res_test_data> QwtIF_TX_FreqResData;
typedef QwtFreqResData<rf_rx_freq_res_test,rf_rx_freq_res_test_data> QwtRF_RX_FreqResData;
typedef QwtFreqResData<if_rx_freq_res_test,if_rx_freq_res_test_data> QwtIF_RX_FreqResData;
