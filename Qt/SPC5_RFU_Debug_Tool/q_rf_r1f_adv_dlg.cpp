...
#include "ui_q_rf_r1f_adv_dlg.h"
#include "q_adf5355_dlg.h"
#include "freq_string.hpp"

QRFR1FAdvDlg::QRFR1FAdvDlg(QWidget *parent) :
    QRFDlg(parent),
    ui(new Ui::QRFR1FAdvDlg)
{
    ui->setupUi(this);
...
QRFR1FAdvDlg::~QRFR1FAdvDlg()
{
    delete ui;
}

void QRFR1FAdvDlg::on_comboBoxTXIOSw2_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_tx_io_sw2(sp1401_r1c::tx_io_sw2_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxTXIOSw1_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_tx_io_sw1(sp1401_r1e::tx_io_sw1_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxTXAtt2_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_tx_att2(index * 0.5);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxTXAtt1_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_tx_att1(index * 0.5);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxTXFilterSw1_currentIndexChanged(int index)
{
    Q_UNUSED(index);
    PTR_CHECK
    RD_TRY
    ...
    SP1401R1F()->set_tx_filter_sw(filter1,filter2);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxTXFilterSw2_currentIndexChanged(int index)
{
    Q_UNUSED(index);
    PTR_CHECK
    RD_TRY
...
void QRFR1FAdvDlg::on_comboBoxTXAtt0_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_tx_att0(index * 0.5);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_pushButtonModEn_clicked()
{
    PTR_CHECK
    RD_TRY
    bool en = ui->pushButtonModEn->isChecked();
    SP1401R1F()->set_tx_modulator_en(en);
    ui->pushButtonModEn->setChecked(en);
    ui->pushButtonModEn->setText(en ? tr("En") : tr("Dis"));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_pushButtonPowerOn_clicked()
{
    PTR_CHECK
    RD_TRY
    bool en = ui->pushButtonPowerOn->isChecked();
    SP1401R1F()->set_pwr_en(en);
    ui->pushButtonPowerOn->setChecked(en);
    ui->pushButtonPowerOn->setText(en ? tr("On") : tr("Off"));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxLoopSw_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_loop_sw(sp1401_r1c::loop_sw_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_pushButtonSetTXLO3_clicked()
{
    PTR_CHECK
    RD_TRY
    quint64 freq = 0;
    ...
    SP1401R1F()->set_adf5355(sp1401_r1c::TX_LO_3,freqLO3);
    SP1401R1F()->det_lo(sp1401_r1c::TX_LO_3,isLock);
...
void QRFR1FAdvDlg::on_pushButtonSetTXLO2_clicked()
{
    PTR_CHECK
    RD_TRY
    quint64 freq = 0;
    ...
    SP1401R1F()->set_adf5355(sp1401_r1c::TX_LO_2,freqLO2);
    SP1401R1F()->det_lo(sp1401_r1c::TX_LO_2,isLock);
...
void QRFR1FAdvDlg::on_pushButtonSetTXLO1_clicked()
{
    PTR_CHECK
    RD_TRY
    quint64 freq = 0;
    ...
    SP1401R1F()->set_adf5355(sp1401_r1c::TX_LO_1,freqLO1);
    SP1401R1F()->det_lo(sp1401_r1c::TX_LO_1,isLock);
...
void QRFR1FAdvDlg::on_pushButtonSetRXLO1_clicked()
{
    PTR_CHECK
    RD_TRY
    quint64 freq = 0;
    ...
    SP1401R1F()->set_adf5355(sp1401_r1c::RX_LO_1,freqLO1);
    SP1401R1F()->det_lo(sp1401_r1c::RX_LO_1,isLock);
...
void QRFR1FAdvDlg::on_pushButtonAdvTXLO3_clicked()
{
    PTR_CHECK
    RD_TRY
    quint8 dlgIdx = 1;
...
void QRFR1FAdvDlg::on_pushButtonAdvTXLO2_clicked()
{
    PTR_CHECK
    RD_TRY
    quint8 dlgIdx = 0;
...
void QRFR1FAdvDlg::on_pushButtonAdvTXLO1_clicked()
{
    PTR_CHECKV(SP3301);
}

void QRFR1FAdvDlg::on_pushButtonAdvRXLO1_clicked()
{
    PTR_CHECK
    RD_TRY
    quint8 dlgIdx = 2;
...
void QRFR1FAdvDlg::on_comboBoxIOMode_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_io_mode(sp1401::io_mode_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_checkBoxTXLED_clicked(bool checked)
{
    Q_UNUSED(checked);
    PTR_CHECK
    RD_TRY
    ...
    SP1401R1F()->set_led(txLed,rxLed);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_checkBoxRXLED_clicked(bool checked)
{
    Q_UNUSED(checked);
    PTR_CHECK
    RD_TRY
...
void QRFR1FAdvDlg::on_pushButtonMCP23S17_clicked()
{
    PTR_CHECKV(SP3301);
}

void QRFR1FAdvDlg::on_pushButtonGetAllTemp_clicked()
{
    PTR_CHECK
    RD_TRY
    ...
    for (quint8 i = 0;i < 3;i ++) {
        SP1401R1F()->get_temp(idx[i],temp[i]);
        lineEditTemp[i]->setText(QString("%1").arg(temp[i]));
    }
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_pushButtonGetAllDet_clicked()
{
    PTR_CHECK
    RD_TRY
...
void QRFR1FAdvDlg::on_comboBoxRXIOSw1_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_rx_io_sw1(sp1401_r1c::rx_io_sw1_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxRXIOSw2_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_rx_io_sw2(sp1401_r1c::rx_io_sw2_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxRXIOSw3_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_rx_io_sw3(sp1401_r1c::rx_io_sw3_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxLNAAttSw_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_rx_lna_att_sw(sp1401::rx_lna_att_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxAtt019Sw_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_rx_att_019_sw(sp1401::rx_att_019_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxRXAtt1_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_rx_att1(index * 0.5);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxRXAtt2_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_rx_att2(index * 0.5);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FAdvDlg::on_comboBoxIFFilterSw_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
