    ...
    ui(new Ui::QRfR1AAdvDlg)
{
    ...
    dlgAdf5355[sp1401_r1a::TX_LO_1] = nullptr;
    dlgAdf5355[sp1401_r1a::TX_LO_2] = nullptr;
    dlgAdf5355[sp1401_r1a::RX_LO_1] = nullptr;
    dlgAdf5355[sp1401_r1a::RX_LO_2] = nullptr;
...
void QRfR1AAdvDlg::on_comboBoxTxIOSw_currentIndexChanged(int index)
{
    ...
    INT_CHECKV(SP1401R1A()->set_tx_io_sw(sw));
}
...
void QRfR1AAdvDlg::on_comboBoxTxBandSw_currentIndexChanged(int index)
{
    ...
    INT_CHECKV(SP1401R1A()->set_tx_band_sw(band));
}
...
void QRfR1AAdvDlg::on_pushButtonModEn_clicked()
{
    ...
    if (SP1401R1A()->set_tx_modulator_en(en)) {
...
void QRfR1AAdvDlg::on_checkBoxTxLED_clicked()
{
    ...
    INT_CHECKV(SP1401R1A()->set_led(txLED,rxLED));
}
...
void QRfR1AAdvDlg::on_comboBoxRxIOSw1_currentIndexChanged(int index)
{
    ...
    INT_CHECKV(SP1401R1A()->set_rx_io_sw1(sw));
}
...
void QRfR1AAdvDlg::on_comboBoxRxIOSw2_currentIndexChanged(int index)
{
    ...
    INT_CHECKV(SP1401R1A()->set_rx_io_sw2(sw));
}
...
void QRfR1AAdvDlg::on_comboBoxRxIOSw_currentIndexChanged(int index)
{
    ...
    INT_CHECKV(SP1401R1A()->set_rx_io_sw(sw));
}
...
void QRfR1AAdvDlg::on_pushButtonAdvTxLO1_clicked()
{
    ...
    if (!dlgAdf5355[loIdx]) {
        ...
        dlgAdf5355[loIdx]->_sp1401_r1a = SP1401R1A();
        ...
        dlgAdf5355[loIdx]->setWindowTitle(QString("R1A/B_ADF5355_RFU%1_RF%2_TX_LO1").arg(SP3301->get_rfu_idx()).arg(rfIdx));
    }
...
void QRfR1AAdvDlg::on_pushButtonAdvTxLO2_clicked()
{
    ...
    if (!dlgAdf5355[loIdx]) {
        ...
        dlgAdf5355[loIdx]->setWindowFlags(Qt::WindowMinimizeButtonHint | Qt::WindowCloseButtonHint);
        dlgAdf5355[loIdx]->setFixedSize(dlgAdf5355[loIdx]->width(),dlgAdf5355[loIdx]->height());
        dlgAdf5355[loIdx]->setWindowTitle(QString("R1A/B_ADF5355_RFU%1_RF%2_TX_LO2").arg(SP3301->get_rfu_idx()).arg(rfIdx));
    }
...
void QRfR1AAdvDlg::on_pushButtonAdvRxLO1_clicked()
{
    ...
    if (!dlgAdf5355[loIdx]) {
        ...
        dlgAdf5355[loIdx]->setWindowFlags(Qt::WindowMinimizeButtonHint | Qt::WindowCloseButtonHint);
        dlgAdf5355[loIdx]->setFixedSize(dlgAdf5355[loIdx]->width(),dlgAdf5355[loIdx]->height());
        dlgAdf5355[loIdx]->setWindowTitle(QString("R1A/B_ADF5355_RFU%1_RF%2_RX_LO1").arg(SP3301->get_rfu_idx()).arg(rfIdx));
    }
...
void QRfR1AAdvDlg::on_pushButtonAdvRxLO2_clicked()
{
    ...
    if (!dlgAdf5355[loIdx]) {
        ...
        dlgAdf5355[loIdx]->setWindowFlags(Qt::WindowMinimizeButtonHint | Qt::WindowCloseButtonHint);
        dlgAdf5355[loIdx]->setFixedSize(dlgAdf5355[loIdx]->width(),dlgAdf5355[loIdx]->height());
        dlgAdf5355[loIdx]->setWindowTitle(QString("R1A/B_ADF5355_RFU%1_RF%2_RX_LO2").arg(SP3301->get_rfu_idx()).arg(rfIdx));
    }
