#include "qcalr1ctxfiltertabwidget.h"
#include <QVBoxLayout>
#include "qcalplot.h"
    ...
    QTabWidget(parent)
{
    ...
    plotRf->init(RF_TX_FILTER_FREQ_STAR_0/1000000.0,RF_TX_FILTER_FREQ_STOP_1/1000000.0,-20.0,10.0);
    ...
    plotIf->init(IF_TX_FILTER_160M_FREQ_STAR/1000000.0,IF_TX_FILTER_160M_FREQ_STOP/1000000.0,-6.0,4.0);
    ...
    dataRfFr_0 = new QwtTxRfFrData;
    dataRfFr_0->calTable()->clear();
    dataRfFr_1 = new QwtTxRfFrData;
    dataRfFr_1->calTable()->clear();
    dataIfFr = new QwtTxIfFrData;
...
void QCalR1CTxFilterTabWidget::init(QR1CTxFilterModel *model_80, QR1CTxFilterModel *model_160)
{
    _model_80 = model_80;
