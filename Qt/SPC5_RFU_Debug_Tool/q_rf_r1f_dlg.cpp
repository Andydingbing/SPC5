...
#include "ui_q_rf_r1f_dlg.h"
#include "algorithm.h"

QRFR1FDlg::QRFR1FDlg(QWidget *parent) :
    QRFDlg(parent),
    ui(new Ui::QRFR1FDlg)
{
    ui->setupUi(this);
...
void QRFR1FDlg::on_lineEditTXFreq_returnPressed()
{
    PTR_CHECK
    RD_TRY
    uint64_t freq = freq_string_to_uint64_t(ui->lineEditTXFreq->text().toStdString());
    SP1401R1F()->set_tx_freq(freq);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FDlg::on_comboBoxTXAtt0_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
...
void QRFR1FDlg::on_comboBoxTXAtt1_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
...
void QRFR1FDlg::on_comboBoxTXAtt2_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
...
void QRFR1FDlg::on_comboBoxIOMode_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_io_mode(io_mode_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FDlg::on_lineEditDGain_textChanged(const QString &arg1)
{
    PTR_CHECK
    RD_TRY
    ...
    //SP1401R1F()->sync_set_tx_gain(att0,att1,att2,att3,d_gain);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FDlg::on_pushButtonSetTXAll_clicked()
{
    PTR_CHECK
    RD_TRY
    double att0 = ui->comboBoxTXAtt0->currentIndex() * 0.5;
    ...
    SP1401R1F()->set_tx_att(att0,att1,att2,0.0);
    SP1401R1F()->set_io_mode(mode);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FDlg::on_lineEditRXFreq_returnPressed()
{
    PTR_CHECK
    RD_TRY
    uint64_t freq = freq_string_to_uint64_t(ui->lineEditRXFreq->text().toStdString());
    SP1401R1F()->set_rx_freq(freq);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FDlg::on_comboBoxRXLNAAttSw_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_rx_lna_att_sw(rx_lna_att_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FDlg::on_comboBoxRXAtt019Sw_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_rx_att_019_sw(rx_att_019_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FDlg::on_comboBoxRXAtt1_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
...
void QRFR1FDlg::on_comboBoxIFFilterSw_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
    SP1401R1F()->set_rx_if_filter_sw(basic_sp1401::rx_if_filter_t(index));
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FDlg::on_comboBoxRXAtt2_currentIndexChanged(int index)
{
    PTR_CHECK
    RD_TRY
...
void QRFR1FDlg::on_pushButtonSetRXAll_clicked()
{
    PTR_CHECK
    RD_TRY
    ...
    SP1401R1F()->set_rx_att(att1,att2,att2);
    SP1401R1F()->set_rx_lna_att_sw(lnaAtt);
    SP1401R1F()->set_rx_att_019_sw(att019);
    SP1401R1F()->set_rx_if_filter_sw(filter);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FDlg::on_pushButtonGetTempDetAll_clicked()
{
    PTR_CHECK
    RD_TRY
    double temp[3] = {0.0};
    ...
    SP1401R1F()->get_temp(0,temp[0]);
    SP1401R1F()->get_temp(5,temp[1]);
    SP1401R1F()->get_temp(6,temp[2]);
    ...
    SP1401R1F()->get_ad7680_tx_if2(det[0]);
    SP1401R1F()->get_ad7680_rx_comb(det[1]);
    SP1401R1F()->get_ad7680_rx_if1(det[2]);
...
void QRFR1FDlg::on_pushButtonSetSN_clicked()
{
    PTR_CHECK
    RD_TRY
    quint32 ordinal = ui->lineEditOrdinal->text().toUInt();
    SP1401R1F()->set_sn_major(R1F,ordinal);
    RD_CATCH_ALL_EXCEPTION
}

void QRFR1FDlg::on_pushButtonGetSN_clicked()
{
    PTR_CHECK
    RD_TRY
    char sn[32] = {0};
    memset(sn,0,sizeof(sn));
    SP1401R1F()->get_sn_major(sn);
