...
{
    int32_t status = 0;
    uint32_t offset = ui->m_LEOffsetK7_0->text().toUInt(nullptr,16);
    uint32_t data = ui->m_LEDataK7_0->text().toUInt(nullptr,16);
    status = _sp2401[1]->get_k7()->w32(pci_dev::AS_BAR0,offset<<2,data);
    Log.add_reg(status,_sp2401[0]->get_k7()->descriptor(),offset,data);
    if (status)
...
void QFPGADlg::on_m_PBRK7_0_clicked()
{
    ...
    Log.add_reg(status,_sp2401[1]->get_k7()->descriptor(),offset,-1,data);
    if (status)
        ui->m_LEStatusK7_0->setText(QString("0x%1").arg(status,8,16,QLatin1Char('0')));
    else
        ui->m_LEStatusK7_0->clear();
...
{
    int32_t status = 0;
    uint32_t offset = ui->m_LEOffsetK7_1->text().toUInt(nullptr,16);
    uint32_t data = ui->m_LEDataK7_1->text().toUInt(nullptr,16);
    status = _sp2401[0]->get_k7()->w32(pci_dev::AS_BAR0,offset<<2,data);
    Log.add_reg(status,_sp2401[1]->get_k7()->descriptor(),offset,data);
    if (status)
...
void QFPGADlg::on_m_PBRK7_1_clicked()
{
    ...
    Log.add_reg(status,_sp2401[0]->get_k7()->descriptor(),offset,-1,data);
    if (status)
        ui->m_LEStatusK7_1->setText(QString("0x%1").arg(status,8,16,QLatin1Char('0')));
    else
        ui->m_LEStatusK7_1->clear();
...
{
    int32_t status = 0;
    uint32_t offset = ui->m_LEOffsetS6_BAR0->text().toUInt(nullptr,16);
    uint32_t data = ui->m_LEDataS6_BAR0->text().toUInt(nullptr,16);
    status = _sp2401[0]->get_s6()->w32(pci_dev::AS_BAR0,offset<<2,data);
    Log.add_reg(status,_sp2401[0]->get_s6()->descriptor(),offset,data);
    if (status)
...
void QFPGADlg::on_m_PBRS6_BAR0_clicked()
{
    ...
    Log.add_reg(status,_sp2401[0]->get_s6()->descriptor(),offset,-1,data);
    if (status)
        ui->m_LEStatusS6_BAR0->setText(QString("0x%1").arg(status,8,16,QLatin1Char('0')));
    else
        ui->m_LEStatusS6_BAR0->clear();
