...
void Q_SP1401_R1A_Widget::on_pushButtonGetTxTemp_clicked()
{
    double temp = 0.0;
...
void Q_SP1401_R1A_Widget::on_pushButtonSetIOMode_clicked()
{
    rd::io_mode_t mode = (rd::io_mode_t)(ui->comboBoxIOMode->currentIndex());
    SP1401_R1A->set_io_mode(mode);
}

void Q_SP1401_R1A_Widget::on_pushButtonSyncSetTxGain_clicked()
{
...
void Q_SP1401_R1A_Widget::on_pushButtonGetRxDet_clicked()
{
    uint32_t det = 0;
...
void Q_SP1401_R1A_Widget::on_pushButtonGetRxTemp_clicked()
{
    double temp = 0.0;
...
void Q_SP1401_R1A_Widget::on_pushButtonSetSN_clicked()
{
...
void Q_SP1401_R1A_Widget::on_pushButtonGetSN_clicked()
{
    char sn[32] = {0};
