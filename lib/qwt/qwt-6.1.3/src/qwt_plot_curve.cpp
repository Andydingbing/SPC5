...
void QwtPlotCurve::setSamples(const int16_t *xData, const int16_t *yData, int size)
{
    setData( new QwtPointArrayData( xData, yData, size ) );
}

void QwtPlotCurve::setSamples(const int16_t *yData, int size)
{
    setData( new QwtPointArrayData( yData, size ) );
}
