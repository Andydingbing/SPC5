...
struct SChartGanttPoint
{
	...
	SChartGanttPoint operator - (double MinuEnd) {SChartGanttPoint Pt;Pt.StartTime = this->StartTime;Pt.EndTime = this->EndTime;Pt.YValue -= MinuEnd;return Pt;}
	SChartGanttPoint operator + (double AddEnd)  {SChartGanttPoint Pt;Pt.StartTime = this->StartTime;Pt.EndTime = this->EndTime;Pt.YValue += AddEnd; return Pt;}
};
