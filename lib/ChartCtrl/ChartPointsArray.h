...
public:
	...
	**/
	...
	// ! Specifies how the points should be hold in the array.
	void SetHolding(PointsHolding newHolding);
...
private:
	...
	//! The holding of the points
	PointsHolding m_Holding;
};
