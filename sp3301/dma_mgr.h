...
public:
    ...
    int32_t dump2buf_ch(uint32_t rf_idx,int32_t *data,uint32_t samples,int32_t *data_2 = NULL);
    int32_t dump2file_ch(uint32_t rf_idx,char *path,uint32_t samples,char *path_2 = NULL);
    int32_t iq2buf(uint32_t rf_idx,int16_t *I,int16_t *Q,uint32_t samples,int16_t *I_2 = NULL,int16_t *Q_2 = NULL);
    int32_t	iq2file(uint32_t rf_idx,char *path,uint32_t samples,char *path_2 = NULL);
private:
	int32_t r_alloc();
	int32_t w_alloc();
	int32_t r_addr2fpga();
