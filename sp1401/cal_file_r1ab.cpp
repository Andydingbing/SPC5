...
cal_file_r1ab::cal_file_r1ab(uint32_t rf_idx,uint32_t rfu_idx) :
...
int32_t cal_file_r1ab::map2buf(cal_item_t item)
{
    ...
    if (item != g_cal_item_buf.item || this->m_rf_idx != g_cal_item_buf.rf_idx || this->m_rfu_idx != g_cal_item_buf.rfu_idx) {
        ...
        switch (item) {
            ...
            case cal_file::TX_SB     : MAP_GLOBAL_DATAF(m_tx_sb,tx_sb_table_r1ab::data_f_t);
            case cal_file::TX_LOL    : MAP_GLOBAL_DATAF(m_tx_lol,tx_lol_table_r1ab::data_f_t);
            case cal_file::TX_ATT_OP : MAP_GLOBAL_DATAF(m_tx_att_op,tx_att_table_r1ab::data_f_t);
            case cal_file::TX_PWR_OP : MAP_GLOBAL_DATAF(m_tx_pwr_op,tx_pwr_table_r1ab::data_f_t);
            case cal_file::TX_PWR_IO : MAP_GLOBAL_DATAF(m_tx_pwr_io,tx_pwr_table_r1ab::data_f_t);
            case cal_file::RX_REF    : MAP_GLOBAL_DATAF(m_rx_ref,rx_ref_table_r1ab::data_f_t);
            case cal_file::TX_ATT_IO : MAP_GLOBAL_DATAF(m_tx_att_io,tx_att_table_r1ab::data_f_t);
			default:return 0;
		}
	}
	return 0;
...
int32_t cal_file_r1ab::map2mem()
{
    ...
    MAP_FILE_DATAM(cal_file::RX_REF,    m_rx_ref);
...
int32_t cal_file_r1ab::add(cal_item_t item,void *data)
{
    ...
    switch (item) {
        ...
        case cal_file::TX_SB     : ADD_DATAF(m_tx_sb,tx_sb_table_r1ab::data_f_t);
        case cal_file::TX_LOL    : ADD_DATAF(m_tx_lol,tx_lol_table_r1ab::data_f_t);
        case cal_file::TX_ATT_OP : ADD_DATAF(m_tx_att_op,tx_att_table_r1ab::data_f_t);
        case cal_file::TX_PWR_OP : ADD_DATAF(m_tx_pwr_op,tx_pwr_table_r1ab::data_f_t);
        case cal_file::TX_PWR_IO : ADD_DATAF(m_tx_pwr_io,tx_pwr_table_r1ab::data_f_t);
        case cal_file::RX_REF    : ADD_DATAF(m_rx_ref,rx_ref_table_r1ab::data_f_t);
        case cal_file::TX_ATT_IO : ADD_DATAF(m_tx_att_io,tx_att_table_r1ab::data_f_t);
		default:return 0;
	}
	return 0;
}
