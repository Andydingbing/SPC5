...
public:
    ...
    DECLARE_CAL_ITEM_TABLE(tx_sb_table_r1ab,RF_TX_FREQ_PTS_CALLED)
public:
    void get(uint64_t freq,double &th,uint16_t &am_i,uint16_t &am_q);
};

// tx sideband r1c/d
class RD_API tx_sb_table_r1cd {
public:
    typedef struct RD_API data_f_t : public tx_sb_table_r1ab::data_f_t {
