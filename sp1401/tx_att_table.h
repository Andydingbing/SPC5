...
class RD_API tx_att_table_r1ab
{
public:
    ...
    DECLARE_CAL_ITEM_TABLE(tx_att_table_r1ab,RF_TX_FREQ_PTS_CALLED)
public:
...
//r1c
class RD_API tx_att_op_table_r1cd
{
public:
    ...
    DECLARE_CAL_ITEM_TABLE(tx_att_op_table_r1cd,RF_TX_FREQ_PTS_CALLED)
public:
...
class RD_API tx_att_io_table_r1cd
{
public:
    typedef struct RD_API data_f_t {
        uint64_t freq;
    ...
    DECLARE_CAL_ITEM_TABLE(tx_att_io_table_r1cd,RF_TX_FREQ_PTS_CALLED)
public:
    float get(uint64_t freq,double pwr);
    void get(uint64_t freq,data_m_t *data);
    void get(uint64_t freq,data_f_t *data);
