...
class RD_API sp1401_r1a : public sp_rd::basic_sp1401
{
public:
...
public:
    ...
    typedef struct tx_chain_state_all_t {
        ...
        uint32_t    det;
        double      temp;
        sp_rd::sp1401::tx_pa_att_t pa_att;
...
public:
    ...
    int32_t io_mode2io_sw(sp_rd::sp1401::io_mode_t mode,
                          tx_io_sw_t &tx_sw,rx_io_sw_t &rx_sw,rx_io_sw1_t &rx_sw1,rx_io_sw2_t &rx_sw2,bool &tx_led,bool &rx_led);
    ...
    int32_t set_tx_pa_att_sw(sp1401::tx_pa_att_t pa_att);
    ...
    int32_t set_rx_att1(double att,double *actual = NULL);
    int32_t set_rx_att2(int32_t att,int32_t *actual = NULL);
    int32_t set_rx_att(double att1,int32_t att2);
    int32_t set_rx_att(double att,double *actual_att1 = NULL,int32_t *actual_att2 = NULL);
