...
{
    m_cal_file = boost::make_shared<cal_file_r1ab>(rf_idx,rfu_idx);
}

sp1401_r1a::~sp1401_r1a()
{
}
...
int32_t sp1401_r1a::init_lo()
{
    ...
    for (int32_t lo_idx = (int32_t)TX_LO_1;lo_idx <= (int32_t)RX_LO_2;lo_idx ++) {
        ...
        adf5355_freq_formula(freq_vco,100000000,false,false,1,ADF5355_FREQ_SPACE,_int,_frac1,_frqc2,_mod1,_mod2);
        reg[0] = adf5355para2reg0(_int,0,1);
        reg[1] = adf5355para2reg1(_frac1);
        reg[2] = adf5355para2reg2(_mod2,_frqc2);
...
cal_file_r1ab *sp1401_r1a::get_cal_file()
{
...
int32_t sp1401_r1a::io_mode2io_sw(io_mode_t mode,tx_io_sw_t &tx_sw,rx_io_sw_t &rx_sw,rx_io_sw1_t &rx_sw1,rx_io_sw2_t &rx_sw2,bool &tx_led,bool &rx_led)
{
    switch (mode) {
...
int32_t sp1401_r1a::set_ltc2666(uint16_t ch,int32_t dac_value)
{
    ...
    RFU_K7_REG_2(0x163f,0x16bf).data_word		= (dac_value << 4);
